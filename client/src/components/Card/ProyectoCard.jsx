...
const ProyectoCard = ({image, title, description, gitHub, deploy})=>{
    return(
                
        <div className="w-1/2 h-full rounded-lg shadow-lg text-left overflow-hidden bg-white">              
            ...
            <div className=" h-1/4 transition duration-300 hover:-translate-y-56">              
                ...
                <div className="my-2  h-64 bg-white">
                    ...
                    <h5 className="text-xl font-bold tracking-wide ml-4 mt-2">{title}</h5>
